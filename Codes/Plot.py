...
def ave_cellnum_x(plot_overall_folder, overall_folder, subfolder, legend_, color_, y_middist):
    ...
    ax.set_title(f'Average cell density along $x$ at ${t_extract_time}$ hrs')
...
def initVoidFibres_cell_fibre_dynamics(plot_overall_folder, fibre_x_2D, fibre_y_2D, x_min, x_max, y_min, y_max, sigma):
    ...
    input_info_path = 'InitNOfibres/sec0.025_deg0.0025_xlen540.0_ylen540.0/rep_0.pickle'
    with open(input_info_path, 'rb') as f:
        cell_coords_T = pickle.load(f)
        Omega_T = pickle.load(f)
...
def initVoidFibres_anisotropy(plot_overall_folder, fibre_x_2D, fibre_y_2D, x_mid, y_mid):
    ...
    ax.set_ylabel(r'average anisotropy degree $a$')
    ax.set_ylim([0, 1.01])
...
if __name__ == "__main__":
    ...
    # For Figures 3 and onwards:
    Numrep = 40
    overall_folders = ['fibredensity/', 
                       'fibreisotropy/', 
                       'degradation/', 
                       'secretion/', 
                       'SI_degradation_secretion/', 
                       'secdeg_parametersweep/']
    subfolders = [[
    ...
    titles = [[r'$\lambda_1+\lambda_2 = 0.1$', 
               r'$\lambda_1+\lambda_2 = 1$'], # cell scatter plot at 40 hours
              ...
              [r'$s=0.0005$ $\rm{min}^{-1}$',
               r'$s=0.05$ $\rm{min}^{-1}$'] # cell and fibre dynamic plot at 40 hours
              #[r'$d=0.0025$ $\rm{min}^{-1}$',
              # r'$d=0.25$ $\rm{min}^{-1}$'] # cell and fibre dynamic plot at 40 hours
             ]

    IC_title_s = ['', '', 'Figure 4', 'Figure 5', 'Figures 6--9, 11']

    xticklabels = [[r'$0.0$', r'$0.1$', r'$0.3$', r'$0.4$', r'$0.5$', r'$1.0$'],
                   [r'$0.0$', r'$0.25$', r'$0.5$', r'$0.75$', r'$0.9$', r'$0.95$'],
                   [], 
    ...
    for i in folder_toextract:
        ...
        # cell and fibre dynamics at 40 hours
