...
def fibre_summarystats_LR(overall_folder, j, input_path, fibre_x_2D, fibre_y_2D, x_mid, y_mid, LR_mask, Numrep, init_density, t_extract_times):
...
if __name__ == "__main__": # FOR CELL INVASION SHOWCASE:
    ...
    tend_iternum, t_extract_times = 42, [21]
    ...
    overall_folder = 'secdeg_parametersweep/'
